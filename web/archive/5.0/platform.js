		...
		menu.settings.addEventListener("click", function(){
			  ...
			  if(window.innerWidth > 500 + parseInt(window.getComputedStyle(document.querySelector("#" + id)).getPropertyValue("width"), 10)){
				...
				if(menu.help.style.display == "none"){
					...
					openHelpNode.innerHTML = "Hilfe und Informationen"; openHelpNode.id = "openHelpNodeInSettingsIframe"; openHelpNode.className = " mdl-button mdl-js-button 	mdl-js-ripple-effect";
				...
				applySettingsNode.innerHTML = "Anwenden und schließen"; applySettingsNode.id = "applySettingsInIframe"; applySettingsNode.className = " mdl-button mdl-js-button 	mdl-js-ripple-effect";
